...
for n_train in SMALL_NS:
    ...
    for seed in SEEDS:
        ...
        try:
            ...
            # Per-cell ckpt dir so models persist across runs and don't collide
            ckpt_dir = f"/tmp/great_ckpt_telco/n{n_train}_seed{seed}"
            ...
            # Persist synthetic data so future α-sweeps / multi-classifier runs
            # don't need to refit GReaT (the expensive step)
            syn_dir = f"{WORK_DIR}/syn_telco"
